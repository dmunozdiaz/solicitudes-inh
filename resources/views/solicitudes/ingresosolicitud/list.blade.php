...
@section('subheader_2')
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
      ...
      <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Ingreso de Solicitudes</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        ...
        <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
          ...
          <!--begin::Item-->
          <li class="breadcrumb-item text-gray-500">Ingreso de Solicitudes</li>
          <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
      </div>
  ...
  <div class="card shadow-sm card-flush mt-6 mt-xl-9">
    ...
    <div class="card-header mt-5">
      ...
      <div class="card-title flex-column">
        ...
        <div class="fs-6 w-lg-700px text-gray-400">Seleccione la solicitud que mejor se ajuste al requerimiento del ciudadano, y presione el botón “Registrar Solicitud”. Puede utilizar el buscador de la derecha indicando algún concepto o palabra clave de la solicitud a registrar.</div>
      </div>
      <!--end::Card title-->
      <!--begin::Card toolbar-->
          ...
          <tbody class="fs-7 fw-normal">
            ...
            <tr>
              ...
              <td class="">
                ...
                @else
                  <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target" data-idsolicitud="{{$solicitud->id}}"  data-subtitle="{{$solicitud->nombresolicitud}}" class="btn btn-primary btn-sm">Registrar Solicitud</a>
                @endif
              ...
              <form id="kt_modal_new_target_form" class="form" action="#">
                  ...
                  <!--end::Heading-->
                   ...
                   <div class="d-flex flex-column mb-8 fv-row">
                      ...
                      <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                          <span class="required">Solicitante:</span>
                          <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Registre el nombre del solicitante."></i>
                         
                      </label>
                      <!--end::Label-->
                      <input class="form-control" type="text" value="" id="solicitante" name="solicitante" />
                      <div class="fv-plugins-message-container" id="solicitante_alert"></div>
                  </div>
                  <!--end::Input group-->
                   <!--begin::Input group-->
                   <div class="d-flex flex-column mb-8 fv-row">
                      ...
                      <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                          <span class="">RUT:</span>
                          <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"  title="Registre el RUT del solicitante. Este campo es relevante dado que el solicitante deberá revisar el estado de su solicitud con su RUT y clave única."></i>
                         
                      </label>
                      <!--end::Label-->
                      <input class="form-control" type="text" value="" id="rut" name="rut" oninput="formatRut(this);" onfocusout="buscarRut()" />
                      <div class="fv-plugins-message-container" id="rut_alert"></div>
                  </div>
                  <!--end::Input group-->
                  <!--begin::Input group-->
                  <div class="d-flex flex-column mb-8 fv-row">
                      ...
                      <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                          ...
                          <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Registre el correo electrónico del solicitante, el que será utilizado para notificarle el estado de su solicitud."></i>
                      </label>
                      <!--end::Label-->
                  ...
                  <!--end::Input group-->
                   ...
                   <div class="d-flex flex-column mb-8 fv-row">
                      ...
                      <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                          ...
                          <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Registre el número telefónico del solicitante (9 dígitos).  Puede ser fijo o móvil."></i>
                      </label>
                      <!--end::Label-->
                  ...
                  <!--end::Input group-->
                   ...
                   <div class="d-flex flex-column mb-8 fv-row">
                    <!--begin::Label-->
                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                        <span class="required" >Procedencia:</span>
                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Seleccione el mecanismo de contacto que usó el solicitante para hacer la solicitud al municipio."></i>
                    </label>
                    <!--end::Label-->
                    <select class="form-control" id="procedencia" name="procedencia">
                      ...
                      <option value="WhatsApp">Oficina de Partes</option>
                      <option value="Otra">Otra</option>

                    </select> 
                    <div class="fv-plugins-message-container" id="procedencia_alert"></div>
                </div>
                <!--end::Input group-->
              
                  <!--begin::Input group-->
                  <div class="d-flex flex-column mb-8">
                      <label class="fs-6 fw-bold mb-2 "> <span class="required">Descripción del requerimiento:</span> <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Describa en detalle la solicitud o consulta del ciudadano. Indique todos los antecedentes que posea."></i> </label>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset("js/solicitudes/ingreso-solicitud-ciudadana.js?v=") }}<?php echo(rand()); ?>"></script>

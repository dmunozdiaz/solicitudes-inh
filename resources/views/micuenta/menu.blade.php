        ...
        <div class="card-body pt-4">
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                <div class="navi-item mb-2">
                    <a href="{{ route('micuenta') }}" class="navi-link py-4 @if(isset($menu->detalle)) active @endif">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('cambiar') }}" class="navi-link py-4 @if(isset($menu->pass)) active @endif">
                        <span class="navi-icon mr-2">

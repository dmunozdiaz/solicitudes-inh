										...
										<div class="card-body d-flex flex-column flex-lg-row flex-stack p-lg-7">
											...
											<div class="d-flex flex-column justify-content-center align-items-center align-items-lg-start me-10 text-center text-lg-start">
												...
												<div class="fs-4 text-muted mb-7">
													En el cuadro inferior de esta página encontrará el listado de solicitudes que usted ha realizado.  Para la revisión, considere lo siguiente:<br>

													1. La columna estado le indicará si la solicitud se encuentra aún en proceso, o si ya fue respondida.<br>
													2. Para revisar el detalle de una solicitud realizada y/o la respuesta entregada por el Municipio, presione el botón “Ver detalle” de la solicitud correspondiente.<br>
												</div>
									...
									<div class="card card-xl-stretch bg-body border-0">
										...
										<div class="card-body d-flex flex-grow-1 flex-column flex-center">
											...
											<div class="d-flex flex-stack">
												<!--begin::Title-->
												<h4 class="fw-bolder text-gray-800 m-0 mb-5">Realizar Solicitudes</h4>
												<!--end::Title-->
											</div>
											<!--end::Heading-->
											<!--begin::Content-->
											<div class="text-center w-100">
												<!--begin::Text-->
												<p class="fw-bold fs-4 text-gray-400 mb-7 px-5">Para realizar una nueva solicitud, haga clic en el siguiente botón y luego seleccione la solicitud correspondiente a su requerimiento.</p>
												<!--end::Text-->
												<!--begin::Action-->
												<div class="m-0">
													<a href="{{ route('solicitudes-ciudadanas') }}" class="btn btn-success fw-bold">Realizar Nueva Solicitud</a>
												</div>
												<!--ed::Action-->
											</div>
											<!--end::Content-->

...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
  ...
  <div class="page-title d-flex flex-column me-3">
    <!--begin::Title-->
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Reporte específico para áreas/departamentos</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
      ...
      <!--end::Item-->
      <!--begin::Item-->
      <li class="breadcrumb-item text-gray-500">Reporte específico para áreas/departamentosl</li>
      <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
  </div>
              ...
              <div class="card bg-body mb-10">
                ...
                <div class="card-body">
                  <div class="fs-5 text-gray-600">
                    <!--begin::Text-->
                    <p>En esta sección podrá descargar reportes en formato XLSX de las solicitudes que han recibido las áreas o departamentos que usted supervisa, donde se incluirá la información de cada solicitud y el estado en el que se encuentra.
                      <br>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset("js/reportes/reporte-especifico.js?v=") }}<?php echo(rand()); ?>"></script>
@endsection
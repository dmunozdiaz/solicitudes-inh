     ...
     <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
         <div class="login-aside d-flex flex-column flex-row-auto" style="background: linear-gradient(to bottom, #02c8e2 0%, #02c8e2 15%, #8a56f6 60%, #8a56f6 100%);">
             <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                 ...
                 <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #FFF;">Servicio Nacional de la Mujer<br>y la Equidad de Género</h3>
             </div>
                 ...
                 <div class="login-form login-signin">
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">¿Olvid&oacute; su contrase&ntilde;a?</h3>
                            <span class="text-muted font-weight-bold font-size-h4">Introduce tu correo electr&oacute;nico para restablecer tu contrase&ntilde;a</span>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Enviar</button>
                            <a href="/" class="btn btn-secondary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Cancelar</a>
                        </div>
                        <!--end::Action-->
                    </form>
                 </div>

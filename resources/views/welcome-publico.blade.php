...
<head>
    ...
    <link href="{{ asset('acceso-solicitudes/public/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('acceso-solicitudes/public/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="bg-body">
    ...
    <script src="{{ asset('acceso-solicitudes/public/assets/plugins/global/plugins.bundle.js') }}"></script>
    <script src="{{ asset('acceso-solicitudes/public/assets/js/scripts.bundle.js') }}"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Page Custom Javascript(used by this page)-->
    <script src="{{ asset('acceso-solicitudes/public/assets/js/custom/authentication/sign-up/general.js') }}"></script>

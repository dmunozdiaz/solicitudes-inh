            ...
            <div class="container">
                <div class="trace trace-as-html">
                        <table class="trace-details">
                            <thead class="trace-head"><tr><th>
                                <h3 class="trace-class">
                                    <span class="exception_title"><span title="ErrorException">Datos Enviados</span></span>
                                </h3>
                                <p class="">User: {{  $content['user'] ?? '' }}</p>
                                <p class="">Id: {{  $content['iduser'] ?? '' }}</p>
                            </th></tr></thead>
                            <tbody>
                                <tr>
                                    <td>
                                        <span class="block trace-file-path"><span title="DATA: "><strong>{{ $content['request'] ?? '' }}</strong></span></span>
                                    </td>
                                </tr>
                        </tbody>
                    </table>

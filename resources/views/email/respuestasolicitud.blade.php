...
<p>Mediante este correo electr&oacute;nico notificamos que la solicitud N&ordm;&nbsp;<span>{{ $appnumbre }}</span> ingresada a trav&eacute;s del sistema de Solicitudes Ciudadanas de nuestra p&aacute;gina web ha sido respondida. A continuaci&oacute;n, se entrega la respuesta:</p>
</td>
</tr>
<tr>
...
<tr>
<td align="justify">Respuesta:&nbsp{{ $respuesta }}</td>
</tr>
</tbody>
<tbody><!--@>array--> <!--@<array--></tbody>
</table>
...
<tr>
<td width="500">
<p align="justify">Puede revisar m&aacute;s detalles de la respuesta en https://solicitudes.temuco.cl, ingresando con su clave &uacute;nica<span class="Apple-converted-space"></span><span style="font-size: 12px;">.</span></p>
</td>
</tr>
</tbody>
</table>

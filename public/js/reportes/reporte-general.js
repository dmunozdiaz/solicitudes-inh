...
/******/ (() => { // webpackBootstrap
    ...
    var page = function () {
      ...
      var _requestStatus = function getTareasSupervisor() {
        ...
        $.ajax({
          url: '/reportes/reporte-general/listreportes',
          type: 'GET',
              ...
              columns:  [{
                ...
                render: function render(data) {
                  ...
                  if(data.estadoreporte == 1){
                    ...
                    return `<a href="/download-reporte/${data.id}"  class="btn btn-clean btn-sm btn-icon btn-icon-ligth ms-auto curso-default" data-request-element="button">
                    <!--begin::Svg Icon | path: icons/duotone/Layout/Layout-4-blocks-2.svg-->
                    <span class="svg-icon svg-icon-2">
                        <!--begin::Svg Icon-->
      ...
      var generarReporte = function filtarSupervisor() {
        $('#generar_reporte').on('click', function () {
          ...
          $.ajax({
            url: '/reportes/reporte-general/generar',
            type: 'POST',
            dataType: "json",
            headers: {

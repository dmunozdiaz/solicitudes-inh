  ...
  var s = i((n, r) => {
    ...
    a.strings = {
      ...
      allowAccessDescription:
        "Para tomar fotos o grabar video con tu c\xE1mara, por favor permite a este sitio el acceso a la c\xE1mara.",
      allowAccessTitle: "Por favor permite el acceso a tu c\xE1mara",
      authenticateWith: "Conectar a %{pluginName}",
      authenticateWithTitle:
        "Por favor autent\xEDcate con %{pluginName} para seleccionar archivos",
      back: "Atr\xE1s",
      ...
      dropPasteBoth: "Soltar archivos aqu\xED, pegar o %{browse}",
      dropPasteFiles: "Soltar archivos aqu\xED, pegar o %{browse}",
      dropPasteFolders: "Soltar archivos aqu\xED, pegar o %{browse}",
      dropPasteImportBoth:
        "Soltar archivos aqu\xED, pegar, %{browse} o importar desde",
      ...
      emptyFolderAdded:
        "Ning\xFAn archivo fue agregado desde la carpeta vac\xEDa",
      encoding: "Codificando...",
      enterCorrectUrl:
        "URL incorrecta: Por favor aseg\xFArate que est\xE1s ingresando un enlace a un archivo",
      enterUrlToImport: "Ingresa una URL para importar un archivo",
      exceedsSize: "Este archivo excede el tama\xF1o m\xE1ximo de ",
      failedToFetch:
        "Companion no ha podido recuperar esta URL, por favor aseg\xFArate que sea correcta",
      ...
      noDuplicates:  "No se puede agregar un archivo duplicado '%{fileName}'",
    };
    a.pluralize = function(e) {
      return e === 1 ? 0 : 1;
    };
    typeof window != "undefined" &&
      typeof window.Uppy != "undefined" &&
      (window.Uppy.locales.es_ES = a);
    r.exports = a;
  });
  s();
})();

...
class User extends Authenticatable
{
    ...
    public function tipossolictudDireccion($iDireccion)
    {
        $tipos = User::select(
            "tipsolicitudes.id",
            "tipsolicitudes.idsolicitud",
            ...
            ->join("tiposolicitud_user", "users.id", "=", "tiposolicitud_user.user_id")
            ->join("tipsolicitudes", "tiposolicitud_user.tiposolicitud_id", "=", "tipsolicitudes.id")
            ->where([["tiposolicitud_user.user_id", "=", Auth::user()->id],['tipsolicitudes.id_direccion','=',$iDireccion]])->get();
    ...
    {
        $tipos = Direccion::select(
            "direccion.id",
            "direccion.direccion"
        )
            ->join("direccion_user","direccion.id","=", "direccion_user.direccion_id",)
            ->where("direccion_user.user_id", "=", Auth::user()->id)
    ...
    public function editar($data)
    {
        ...
        $direcciones = DireccionUser::where('user_id', '=', $data['id_usuario'])->get();
